...
@Component
class Reports(private val reportingService: ReportingService, private val cacheManager: CacheManager) :
    ApplicationRunner {
    ...
    override fun run(args: ApplicationArguments) {
        ...
        log.info("execution 2: ${reportingService.generateMonthlySalesReport(1, 2024)}")
        log.info("execution 1: ${reportingService.generateMonthlySalesReport(2, 2024)}")
        reportingService.resetReport("generateMonthlySalesReport1, 2024")
        log.info("execution 1: ${reportingService.generateMonthlySalesReport(1, 2024)}")
        log.info("execution 2: ${reportingService.generateMonthlySalesReport(1, 2024)}")
        log.info("execution 1: ${reportingService.generateMonthlySalesReport(2, 2024)}")
        reportingService.insertReport("generateMonthlySalesReport1, 2024")
        log.info("execution 1: ${reportingService.generateMonthlySalesReport(1, 2024)}")
        log.info("execution 2: ${reportingService.generateMonthlySalesReport(1, 2024)}")
        log.info("execution 1: ${reportingService.generateMonthlySalesReport(2, 2024)}")
        ...
        cache?.clear()
        cache?.put("generateMonthlySalesReport1, 2024", 1.0)
        cache?.get("generateMonthlySalesReport2, 2024", Double::class.java)*/
    }
